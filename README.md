...
* Adding a swagger or similar landing page to the API for developers to be able to navigate the endpoints easily so that the developer in charge of updating front end connections is able to understand the data flow. 
